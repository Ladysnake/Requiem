...
public class TileEntityCrystallizer extends TileEntityLockable implements ITickable, ISidedInventory 
{
    ...
    {
        return CrystallizerRecipes.instance().crystalTimeList.get(stack.getItem()) == null ? 200 : CrystallizerRecipes.instance().crystalTimeList.get(stack.getItem());
    }
