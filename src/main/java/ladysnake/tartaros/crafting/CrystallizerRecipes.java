package ladysnake.tartaros.crafting;
...
public class CrystallizerRecipes {
	...
	public final Map<ItemStack, Integer> crystalTimeList = Maps.<ItemStack, Integer>newHashMap();
	...
	public void addCrystalRecipe(ItemStack input, ItemStack output, int time){
        ...
        this.crystalTimeList.put(output, time);
	}
