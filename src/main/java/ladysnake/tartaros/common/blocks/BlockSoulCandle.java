...
public class BlockSoulCandle extends Block implements ITileEntityProvider {
	...
	public BlockSoulCandle() {
		super(Material.GLASS);
		this.setUnlocalizedName(Reference.Blocks.SOUL_CANDLE.getUnlocalizedName());
		this.setRegistryName(Reference.Blocks.SOUL_CANDLE.getRegistryName());
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn,
		...
		playerCorp.setSoulCandleNearby(true);
		/*
		if(worldIn.isRemote) {
