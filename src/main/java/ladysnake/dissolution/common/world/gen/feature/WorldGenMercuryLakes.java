package ladysnake.dissolution.common.world.gen.feature;
...
public class WorldGenMercuryLakes extends WorldGenerator{

	private final Block block;

    public WorldGenMercuryLakes(Block blockIn)
    {
        this.block = blockIn;
    }
