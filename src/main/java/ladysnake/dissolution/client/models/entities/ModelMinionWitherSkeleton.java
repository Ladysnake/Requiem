...
public class ModelMinionWitherSkeleton extends ModelBiped
{
    public ModelMinionWitherSkeleton()
    {
        this(0.0F, false);
    }

    public ModelMinionWitherSkeleton(float modelSize, boolean show)
    {
    ...
    public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor, Entity entityIn)
    {
        ...
        if (!((EntityMinionWitherSkeleton) entityIn).isCorpse()) {
        	...
        	((EntityMinionWitherSkeleton) entityIn).isAIDisabled();		
			// right arm
