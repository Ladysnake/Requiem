...
public final class RequiemBlockEntities {
    public static final BlockEntityType<RunicObsidianBlockEntity> RUNIC_OBSIDIAN = FabricBlockEntityTypeBuilder.create(RunicObsidianBlockEntity::new, RequiemBlocks.RUNIC_TACHYLITE_ATTRITION).build(null);
