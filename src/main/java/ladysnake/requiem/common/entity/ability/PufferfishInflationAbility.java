...
/**
 * Depends on {@link ladysnake.requiem.mixin.common.possession.gameplay.ability.PufferfishEntityMixin} to work
 */
public class PufferfishInflationAbility extends IndirectAbilityBase<PufferfishEntity> {
    public PufferfishInflationAbility(PufferfishEntity owner) {
        super(owner, 0);
    }
