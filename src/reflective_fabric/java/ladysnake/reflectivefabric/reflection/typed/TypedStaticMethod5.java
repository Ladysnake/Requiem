...
public class TypedStaticMethod5<P1, P2, P3, P4, P5, R> extends TypedStaticMethod {
    public TypedStaticMethod5(MethodHandle methodHandle, String name, Class<?> declaringClass) {
    ...
    public R invoke(P1 p1, P2 p2, P3 p3, P4 p4, P5 p5) {
        try {
            return (R) methodHandle.invoke(p1, p2, p3, p4, p5);
