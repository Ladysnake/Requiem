...
public class TypedStaticMethod4<P1, P2, P3, P4, R> extends TypedStaticMethod {
    public TypedStaticMethod4(MethodHandle methodHandle, String name, Class<?> declaringClass) {
    ...
    public R invoke(P1 p1, P2 p2, P3 p3, P4 p4) {
        try {
            return (R) methodHandle.invoke(p1, p2, p3, p4);
